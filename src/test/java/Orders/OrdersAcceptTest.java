 ...
 public class OrdersAcceptTest {
    ...
    public void testAcceptOrderWithoutCourierId() {
        try {
            ...
            // Вывод детальной информации при ошибке
            System.err.println("Ошибка в тесте:");
            System.err.println("Статус ответа: " + response.statusCode());
    ...
    public void testAcceptOrderWithInvalidOrderId() {
        try {
            ...
            // Добавляем логирование запроса и ответа
            System.out.println("Статус ответа: " + response.statusCode());
            System.out.println("Тело ответа: " + response.getBody().asString());
            ...
            // Выводим дополнительную информацию при ошибке
            System.err.println("Ошибка в тесте:");
            System.err.println("Статус ответа: " + response.statusCode());
            System.err.println("Тело ответа: " + response.getBody().asString());
            throw e;
